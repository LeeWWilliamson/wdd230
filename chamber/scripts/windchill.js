...
const url = 'https://api.openweathermap.org/data/2.5/weather?q=Bothell&units=imperial&appid=c3b80b0b52a3df6207da3081ae49e184';
...
function calc_windChill(temp, speed){
  if (temp <= 50  && speed >= 3.0) {
    ...
    // document.querySelector("#wind-chill").textContent = temp + "℉";
